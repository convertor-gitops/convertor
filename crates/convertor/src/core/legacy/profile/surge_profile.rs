...
use crate::core::legacy::util::{extract_policies, group_by_region};
...
impl SurgeProfile {
    #[instrument(skip_all)]
    pub fn parse(content: &str) -> Result<SurgeProfile, ParseError> {
        <Self as crate::core::legacy::Parse<crate::core::legacy::format::SurgeFormat>>::parse(content)
    }
