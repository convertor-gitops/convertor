...
use crate::core::legacy::util::{best_filter_from_proxy_names, extract_policies, group_by_region};
pub use geox_url::*;
...
pub struct ClashProfile {
    /// Comments are retained as content; original placement is not part of the model.
    ...
    #[serde(with = "crate::core::legacy::profile::policy_map")]
...
impl ClashProfile {
    ...
    pub fn parse(content: &str) -> Result<Self, ParseError> {
        <Self as crate::core::legacy::Parse<crate::core::legacy::format::ClashFormat>>::parse(content)
    }

    // #[instrument(skip_all)]
    // pub fn template() -> Result<Self, ParseError> {
    //     clash_parser::parse(TEMPLATE_STR)
    // }
...
impl Default for ClashProfile {
    fn default() -> Self {
        Self {
            ...
            secret: None,
            geo_auto_update: default_geo_auto_update(),
            geo_update_interval: default_geo_update_interval(),
            geox_url: Default::default(),
            proxies: vec![],
            proxy_providers: Default::default(),
            proxy_groups: vec![],
