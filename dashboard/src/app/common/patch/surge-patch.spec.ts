...
describe("mergeRuleEntries + resolveDefault", () => {
    ...
    const newEntries: RuleEntry[] = [
        { label: "[Subscription]", policyName: "DIRECT", option: null, url: "https://new.example.com/sub", version: "2.6.30", disabled: false },
        { label: "[DIRECT: no-resolve]", policyName: "DIRECT", option: "no-resolve", url: "https://new.example.com/dnr", version: "2.6.30", disabled: false },
        { label: "[Netflix]", policyName: "Netflix", option: null, url: "https://new.example.com/nf", version: "2.6.30", disabled: false },
    ];
